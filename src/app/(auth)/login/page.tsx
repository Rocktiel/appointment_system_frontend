...
//   const [checking, setChecking] = useState(true); // başlangıçta auth kontrol ediyoruz
...
//       if (isAuthenticated) {
//         router.push(`/dashboard/${role.toLowerCase()}`); // giriş yapmışsa dashboard'a yönlendir
//       } else {
//         setChecking(false); // giriş yoksa formu göster
//       }
//     };
...
//   if (checking) {
//     return <div>Yükleniyor...</div>; // bu kısmı dilersen loader komponentiyle değiştir
//   }
//   return (
